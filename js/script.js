...
function coverSlide() {
  return `
        <div class="min-h-screen w-full bg-gradient-cachina-mix flex items-center justify-center relative overflow-hidden">
    </div>
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-6xl mx-auto">
                ...
                <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-slide-up animate-delay-200 text-white text-center leading-tight">
                    Inspirando o
                    <span class="block bg-gradient-to-r from-blue-400 to-sky-300 bg-clip-text drop-shadow-2xl">
                        FUTURO DIGITAL
                    </span>
                    das Empresas
                </h1>
                ...
                <p class="text-xl md:text-2xl font-light mb-12 animate-slide-up animate-delay-300 max-w-4xl text-gray-300 leading-relaxed text-center">
                    "Acreditamos que a tecnologia é um poderoso instrumento para
                    impulsionar o crescimento, a competitividade e a inovação dos
                    negócios."
                </p>

                <!-- Enhanced Stats - CENTRALIZADO -->
                <div class="animate-slide-up animate-delay-400 flex items-center justify-center gap-3 text-lg">
                    <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-sky-400 rounded-full flex items-center justify-center shadow-lg">
